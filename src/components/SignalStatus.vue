<template>
  ...
  <p v-if="statusData.available">Последнее обновление {{ statusData.lastGet }}</p>
</template>
...
const statusData = setupDataService<SummarySignalReceiveStatus>({
  url: "/signal_status",
  updateRate: 10000,
});
</script>
